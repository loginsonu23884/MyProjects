...
(function(a) {
    a.widget("ui.autocomplete", {
              ...
              var e = a.ui.keyCode; 
               //var e = 9;
                ...
                default:
                    ...
                    b.searching = setTimeout(function() { b.search(null, d) }, b.options.delay);
                    break
                }
            }).bind("focus.autocomplete", function() { b.previous = b.element.val() }).bind("blur.autocomplete", function(d) {
                clearTimeout(b.searching);
                b.closing = setTimeout(function() { b.close(d) }, 150)
            });
            this._initSource();
        ...
        _suggest: function(b) {
            var c = this.menu.element.empty(), d, e;
...
(function(a) {
    a.widget("ui.menu", {
        ...
        refresh: function() {
            ...
            b.children("a").addClass("ui-corner-all").attr("tabindex", -1).mouseenter(function() { c.activate(a(this).parent()) }).mouseleave(function() { c.deactivate() })
        },
        activate: function(d) {
            this.deactivate();
            if (this.hasScroll()) {
